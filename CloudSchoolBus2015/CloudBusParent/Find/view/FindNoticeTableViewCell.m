...
-(void)setMesssage:(Message *)messsage
{
    ...
    else if([messsage.apptype isEqualToString:@"Article"])
    {
        ...
        if(picArr.count == 1)
        {
            ...
            [imageView sd_setImageWithURL:[NSURL URLWithString:picArr[0]] placeholderImage:nil];
        ...
        else if(picArr.count > 1)
        {
            for (int i = 0; i < picArr.count; i++) {
                ...
                UIImageView *imageView = [[UIImageView alloc]init];
                [imageView sd_setImageWithURL:[NSURL URLWithString:picArr[i]] placeholderImage:nil];
                [self.contentView addSubview:imageView];
