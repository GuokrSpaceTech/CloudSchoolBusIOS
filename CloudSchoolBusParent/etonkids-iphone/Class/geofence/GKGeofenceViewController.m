        ...
        if(code==1)
        {
            ...
            else
            {
                ...
                topView.frame=CGRectMake(0, NAVIHEIGHT + (ios7 ? 20 : 0), self.view.frame.size.width, 40);
                  topView.hidden=NO;
                _tableView.frame=CGRectMake(0, NAVIHEIGHT + (ios7 ? 20 : 0)+topView.frame.size.height, self.view.frame.size.width, self.view.frame.size.height - NAVIHEIGHT-(ios7 ? 20 : 0)-topView.frame.size.height);
