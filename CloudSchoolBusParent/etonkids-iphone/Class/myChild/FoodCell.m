...
//        {
        ...
        self.leftBackView = [[UIView alloc] initWithFrame:CGRectMake(10, 5, 100, backView.frame.size.height)];
        ...
        self.LeftImageview=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 38, 38)];
        self.LeftImageview.backgroundColor = [UIColor clearColor];
        [self.contentView addSubview:self.LeftImageview];
        [self.LeftImageview release];
            
        self.ChineseLabel=[[UILabel alloc]initWithFrame:CGRectMake(120, 10, 180, 0)];
        ...
        self.leftTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 5, 100, 40)];
