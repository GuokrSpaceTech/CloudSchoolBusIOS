...
//  etonkids-iphone
//
//  Created by CaiJingPeng on 13-12-21.
...
- (void)viewDidLoad
{
    ...
    middleLabel.text = LOCAL(@"setting_help", @"");
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.yunxiaoche.com/help"]]];
