...
- (void)checkForNewVersionInBackground
{
    @synchronized (self)
    {
        @autoreleasepool
        {
            ...
            iTunesServiceURL = [iTunesServiceURL stringByAddingPercentEscapesUsingEncoding: NSUTF8StringEncoding];
            ...
            if (data)
            {
                ...
                {
                    //&& [bundleID isEqualToString:self.applicationBundleID]
                    //get version details
