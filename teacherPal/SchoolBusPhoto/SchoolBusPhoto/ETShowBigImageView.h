...
@interface ETShowBigImageView:UIView<UIScrollViewDelegate,UIActionSheetDelegate,MFMailComposeViewControllerDelegate,ETZoomScrollViewDelegate>
{
    int originShowNum;
    UILabel *item;


    ETZoomScrollView *zoomImgV;
