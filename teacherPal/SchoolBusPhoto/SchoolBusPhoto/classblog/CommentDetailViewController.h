...
@interface CommentDetailViewController : GKBaseViewController<EKProtocol,UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,UIActionSheetDelegate,UITextViewDelegate,GKMovieDownloaderDelegate>
{
    CGFloat floatheight;
